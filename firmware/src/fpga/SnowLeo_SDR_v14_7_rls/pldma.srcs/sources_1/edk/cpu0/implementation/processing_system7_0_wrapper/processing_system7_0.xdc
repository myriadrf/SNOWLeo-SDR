...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_0 -period "5.333" [get_nets "FCLK_CLK0"]
set_input_jitter clk_fpga_0 0.15999
create_clock -name clk_fpga_1 -period "6.666" [get_nets "FCLK_CLK1"]
set_input_jitter clk_fpga_1 0.19998
create_clock -name clk_fpga_2 -period "10" [get_nets "FCLK_CLK2"]
